...
classdef World < handle
   ...
   methods
       ...
       function self = World(robotPosition)

        filepath = fileparts(which('World.m'));

        addpath(genpath(fullfile(filepath, '..', 'robot-model')));
        addpath(genpath(fullfile(filepath, '..', 'sim')));
        addpath(genpath(fullfile(filepath, '..', 'controller')));
        addpath(genpath(fullfile(filepath, '..', 'kinematic')));
